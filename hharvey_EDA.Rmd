...
Viewing the entire dataset in the Data Viewer window by clicking on the data frames name in the Environment or running the `View()` command in the Console can be ineffective since the Data Viewer only shows the first 100 columns of the data frame. 
